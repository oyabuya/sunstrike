...
- Pemilik melihat `/candidates` 0 dari 6. Funnel VPS 2026-09-24 20:16 UTC menunjukkan enam pool unik setelah filter API: JEANPHIL, dua pool familiars, dan ANTHROPIC gagal lantaran aktivitas 5m setara di bawah ambang; OTC dan goon gagal karena bukti volume/fee/active TVL segar hilang. Angka enam bukan batas scan; discovery membaca maksimal 50 per window dan memperkaya maksimal 50 alamat unik. Patch Telegram `/candidates` menampilkan nama/alamat pendek dan alasan seluruh penolakan lokal serta menjelaskan arti hitungan; perlu tes, commit, deploy DRY_RUN, verifikasi.
