...
- Permintaan uji DRY_RUN dengan lebih banyak kandidat: log funnel terbaru mayoritas menolak pool karena aktivitas 5m lemah/hilang; gate aktivitas dan audit token tetap. Probe Pool Discovery max TVL $150k vs $500k menemukan tambahan pool; full screening sementara pada $500k mendapatkan dua pool familiars eligible dari delapan pool unik, termasuk pool ~$191k TVL yang tidak terlihat pada batas lama. Default `maxTvl` dinaikkan ke $500k dan commit `de2f85f` sudah di-push/deploy; 61 tes VPS lulus, service active, `DRY_RUN=true`. Siklus awal berhenti pada 2/2 posisi; screening baca-saja saat itu melihat lima pool dan nol eligible karena aktivitas segar melemah/posisi telah terbuka. Patch berikutnya membuat DRY_RUN tetap mencatat funnel awal saat posisi penuh, tanpa Jev/Luna/deploy; perlu commit/deploy/verifikasi. Ini belum membuktikan peningkatan kandidat eligible secara konsisten.
