...
- Screenshot pemilik menunjukkan reply keyboard Telegram yang dapat diekspansi lewat ikon empat kotak pada input, berbeda dari slash command menu. Patch lanjutan lokal menambahkan keyboard dua kolom pada pesan siap dan `/help`, dengan tombol yang dipetakan ke handler yang sama; tombol close tidak dipasang untuk mencegah salah tekan. Perlu verifikasi UI setelah deploy DRY_RUN.
