...
// ─── Strategy Mapping ───────────────────
 strategy: {
  ...
  llm: {
    ...
    maxStepsManager:  u.maxStepsManager  ?? 6,   // management is mechanical — rarely needs > 4 steps
    maxStepsScreener: u.maxStepsScreener ?? 12,  // screening needs room for enrichment + final answer
    managementModel: u.managementModel ?? process.env.LLM_MODEL ?? "openai/gpt-4.1-mini",
    screeningModel:  u.screeningModel  ?? process.env.LLM_MODEL ?? "openai/gpt-4.1-mini",
    generalModel:    u.generalModel    ?? process.env.LLM_MODEL ?? "openai/gpt-4.1-mini",
  },
